...
- [20200306](https://robertslab.github.io/sams-notebook/2020/03/06/RNA-Isolation-and-Quantification-C.bairdi-RNA-from-Hemolymph-Pellets-in-RNAlater.html)
...
Overall, the yields aren't particularly great and are significantly lower than [when I previously "co-isolated" RNA/DNA using this kit on 20200117](https://robertslab.github.io/sams-notebook/2020/01/17/DNA-Isolation-and-Quantification-C.bairdi-Hemolymph-Pellets-in-RNAlater.html). The primary difference between today and 20200117 is that today's samples had been stored on the column for multiple days, whereas the samples from 20200117 were isolated immediately after the RNA isolation procedure was completed. Interesting...
