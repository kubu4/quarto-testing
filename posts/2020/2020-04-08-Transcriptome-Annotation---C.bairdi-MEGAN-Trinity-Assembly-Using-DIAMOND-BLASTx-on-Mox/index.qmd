...
categories:
  ...
  - Miscellaneous
---
As part of annotating the most recent [transcriptome assembly from the MEGAN6 _Arthropoda_ taxonomic-specific reads](https://robertslab.github.io/sams-notebook/posts/2020/2020-03-30-Transcriptome-Assembly-C.bairdi-with-MEGAN6-Taxonomy-specific-Reads-with-Trinity-on-Mox.html), I need to run DIAMOND BLASTx to use with Trinotate./
