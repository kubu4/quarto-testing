...
[I recently finished an assembly of our Olympia oyster PacBio data using Canu](https://robertslab.github.io/sams-notebook/posts/2017/2017-10-18-genome-assembly-olympia-oyster-pacbio-canu-v1-6.html) and thought it would be interesting to compare to [Sean's Canu assembly](https://genefish.wordpress.com/2017/06/19/seans-notebook-canu-run-finished/)./
