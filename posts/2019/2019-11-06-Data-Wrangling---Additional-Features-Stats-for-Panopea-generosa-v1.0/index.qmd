...
I'd [previously created intron and intergenic features](https://robertslab.github.io/sams-notebook/posts/2019/2019-10-30-Data-Wrangling-Create-Panopea-generosa-vv0.74.a4-Intron-and-Intergenic-BED-Files.html), but didn't do any sort of analysis on them. In order to try to mirror some of what is in the table linked above, we need some stats from the introns file./
