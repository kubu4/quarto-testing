...
---
Per [this thread in Slack](https://genefish.slack.com/archives/GHB1LCNRW/p1560979157005300?thread_ts=1560978863.004100&cid=GHB1LCNRW), we realized that the ["final" annotation of the Olurida_v081 genome](https://robertslab.github.io/sams-notebook/posts/2019/2019-01-09-Annotation-Olurida_v081-MAKER-Functional-Annotations-on-Mox.html) only seemed to have singular mRNA annotations and no apparent isoforms. As such, I decided to see if I could tease out this type of info./
