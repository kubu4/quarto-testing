...
With the remainder of the [library sample prepared earlier](https://robertslab.github.io/sams-notebook/posts/2014/2014-12-22-bisulfite-ngs-library-lsu-c-virginica-oil-spill-mbd-bisulfite-dna-sequencing-submission.html), I performed the recommended clean up procedure for removing adaptor sequences in the EpiNext Post-Bisulfite DNA Library Preparation Kit – Illumina (Epigentek).    Briefly:/
